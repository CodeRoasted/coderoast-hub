...
> Evidence snapshot for **v1.7.6**. Regenerated on every cut; the digests below move
...
| --- | --- | --- |
| `canon.det_proof.txt` | `118f7247d7513c9224bee8a9412c25d14a974ee20979ee577bb85b67d4f9ef40` | canon public determinism proof — tokenization + event extraction over a fixed corpus |
